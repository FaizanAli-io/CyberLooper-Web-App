  ...
  return (
    <>
      ...
      <div className="pricing-page">
        {/* Hero Title */}
        <h1 className="hero-title">Free During Beta</h1>
        ...
        <div className="frame-1171275828">
          <h2 className="section-title">Early Access Advantages</h2>
        ...
        {/* Line 533 */}
        <div className="divider line-533"></div>
        
        {/* Third Section - Why Sign Up Now? */}
        <div className="frame-1171275830">
          <h2 className="section-title">Why Sign Up Now?</h2>
          <div className="content-div">
            <p className="content-text">
        ...
        {/* Line 532 */}
        <div className="divider line-532"></div>
