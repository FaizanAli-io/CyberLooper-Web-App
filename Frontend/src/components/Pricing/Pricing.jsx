    ...
    <>
      ...
      <div className="pp-pricing-container">
        ...
        <p className="pp-hero-subtitle">
          Full Feature Access: Experience our entire suite of data tools at no
          cost. Direct Feedback Loop: Influence upcoming features and
          improvements by providing valuable insights. No Hidden Fees: Zero
          credit card details required; sign up and start using Cyberlooper
          risk-free.
        </p>
        ...
        <div className="pp-section-container">
          ...
          <div className="pp-content-wrapper">
            <p className="pp-content-text">
              Full Feature Access: Experience our entire suite of data tools at
              no cost. Direct Feedback Loop: Influence upcoming features and
              improvements by providing valuable insights. No Hidden Fees: Zero
              credit card details required; sign up and start using Cyberlooper
              risk-free.
            </p>
        ...
        <div className="pp-section-container">
          ...
          <div className="pp-content-wrapper">
            <p className="pp-content-text">
              Exclusive Access: Be among the first to benefit from our latest
              updates and features. Cost-Free Development: Leverage
              Cyberlooper's advanced analytics and automation to jumpstart your
              projects without draining your budget. Priority Support: Beta
              users receive dedicated support and faster response times, so your
              feedback leads directly to product enhancements.
            </p>
          </div>
        </div>
        ...
        <div className="join-future-section">
          <div className="join-future-content">
            ...
            <p className="join-subtitle">
              Sign up now to experience the AI advantage.
            </p>
          </div>
          <button
            className="join-future-btn"
