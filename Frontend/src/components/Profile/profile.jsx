...
const Profile = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${API_ENDPOINT}/users/change-password`, passwordData, {
        headers: { Authorization: `Bearer ${token}` },
      });
    ...
    <div className="profile-page-background">
      <div className="profile-page-container">
        <div className="profile-page-header">
          ...
          <p>
            Keep your profile accurate so the Cyberlooper can tailor suggestions
            to your unique role and work environment!
          </p>
        </div>
        ...
        <div className="profile-page-content">
          <div className="profile-page-form-container">
            <form onSubmit={handleUpdate} className="profile-page-details-form">
              ...
              <div className="profile-page-button-container">
                <button type="submit" className="profile-page-update-button">
                  Save Changes
                </button>
              </div>
            </form>
          ...
          <div className="profile-page-security-section">
            <div className="profile-page-security-header">
              ...
              <p>
                Your safety is our top priority. Manage your login, password,
                and additional security measures here
              </p>
            </div>
            ...
            <div className="profile-page-password-toggle-container">
              <div className="profile-page-toggle-header">
                ...
                <p>
                  Keep it fresh—update your password regularly for better
                  protection.
                </p>
              </div>
              <div
                className={`profile-page-toggle-switch ${
                  changePasswordVisible ? "profile-page-toggle-active" : ""
                }`}
            ...
            {changePasswordVisible && (
              <div className="profile-page-password-form-container">
                {passwordMessage && (
                  <p className="profile-page-password-message">
                    {passwordMessage}
                  </p>
                )}
                <form
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="profile-page-password-button"
                  >
                    Update Password
                  </button>
                </form>
            ...
            <div className="profile-page-danger-zone">
              ...
              <button
                ...
                className="profile-page-delete-button"
              >
                DELETE ACCOUNT
              </button>
            </div>
