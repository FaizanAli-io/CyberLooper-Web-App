        ...
        <div className="home-content">
          ...
          <div className="quote-section">
            ...
            <p className="quote-text">
              Experience faster decision-making, effortless collaboration, and
              unwavering data privacy— all powered by an AI built for the modern
              workplace.
            </p>
          </div>
          ...
          <div className="value-prop-row">
            <div className="value-prop-block">
              ...
              <p className="prop-text">
                Lightning-Fast Answers: Get near-instant responses tailored to
                your specific work tasks.
              </p>
            </div>
            ...
            <div className="value-prop-block">
              ...
              <p className="prop-text">
                Excel, Power BI, and Tableau: Instantly know the right formula
                or data visualization trick.
              </p>
            </div>
            ...
            <div className="value-prop-block">
              ...
              <p className="prop-text">
                Brainstorm Better: Spark ideas, share best practices, and
          ...
          <div className="testimonial-card">
            <div className="testimonial-content">
              <p className="testimonial-text">
                I used to memorize dozens of financial formulas for portfolio
                analysis. Now I just ask for the calculation I need, and the AI
                instantly delivers the perfect ratio or equation.
              </p>
