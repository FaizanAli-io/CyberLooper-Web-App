        ...
        <div className="about-content">
          ...
          <section className="about-section">
            ...
            <p className="mission-statement">
              At Cyberlooper, our mission is to simplify how people tackle complex work challenges by providing intuitive, efficient tools.
            </p>
          ...
          <section className="approach-section">
            <div className="approach-content">
              <h3 className="approach-title">Our Approach to Data and Productivity</h3>
          ...
          <section className="value-props-section">
            ...
            <div className="value-row">
              <div className="value-card">
                ...
                <p className="value-text">Efficiency - Save time and resources.</p>
              </div>
              ...
              <div className="value-card">
                ...
                <p className="value-text">Productivity - Streamline routine tasks.</p>
              </div>
              ...
              <div className="value-card">
                ...
                <p className="value-text">Collaboration - Enhance team communication.</p>
              </div>
            </div>
            ...
            <div className="value-row">
              <div className="value-card">
                ...
                <p className="value-text">Adaptability - Evolve with business changes.</p>
              </div>
              ...
              <div className="value-card">
                ...
                <p className="value-text">Customer Success - Measure success by client success.</p>
              </div>
              ...
              <div className="value-card">
                ...
                <p className="value-text">Cutting-Edge Technology - Stay ahead of tech trends.</p>
              </div>
            </div>
          </section>
          ...
          <section className="vision-section">
            <p className="vision-text">
              Cyberlooper began as a shared vision among data professionals in San Antonio. We focus on making data simpler and truly impactful.
            </p>
          </section>
          {/* Why Choose Section */}
