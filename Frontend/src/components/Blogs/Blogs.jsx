        ...
        <div className="kb-blog-page">
          ...
          <div className="kb-hero-section">
            ...
            <p className="kb-hero-subtitle">
              Explore our collection of articles, guides, and updates to master
              the art of getting things done with your AI assistant—safely and
              efficiently.
            </p>
            ...
            <div className="kb-admin-section">
              <div className="kb-admin-panel">
                ...
                <div className="kb-form-group">
                  <label className="kb-form-label">Blog Title</label>
                  <input
                    type="text"
                    value={newTitle}
                ...
                <div className="kb-form-group">
                  <label className="kb-form-label">Blog Caption</label>
                  <textarea
                    value={newCaption}
                ...
                <div className="kb-form-group">
                  <label className="kb-form-label">Blog Image</label>
                  <input
                    type="file"
                ...
                {postError && <p className="kb-error-message">{postError}</p>}
              </div>
                    ...
                    <div key={blog.id} className="kb-blog-list-item">
                      <div className="kb-blog-list-content">
                        ...
                        <div className="kb-blog-details">
                          ...
                          <p className="kb-blog-caption">{blog.caption}</p>
                      ...
                      {editId === blog.id && (
                        <div className="kb-edit-form">
                          ...
                          <div className="kb-form-group">
                            <label className="kb-form-label">Edit Title</label>
                            <input
                              type="text"
                              value={editTitle}
                      ...
                      <div key={blog.id} className="kb-blog-card">
                        ...
                        <div className="kb-blog-card-content">
                          <div className="kb-blog-card-header">
                            <span className="kb-blog-card-category">
                              Knowledge Base
                            </span>
                            <div className="kb-blog-card-title-wrapper">
                              <h3 className="kb-blog-card-title">
                                {blog.title || "Untitled"}
                              </h3>
                              <div className="kb-blog-card-icon"></div>
                            </div>
                            <p className="kb-blog-card-excerpt">
                              {blog.caption}
                            </p>
                          </div>
